...
function ReviewProdukPage() {
	...
	const handleReview = (e) => {
		...
		if (rating === 0) {
			...
			const dataBumbu = {
				overal_star:
					(reviewByID.bumbuProduk_id.overal_star *
						reviewByID.bumbuProduk_id.total_review +
						rating) /
					(reviewByID.bumbuProduk_id.total_review + 1),
	...
	return (
		<>
			...
			{review.isLoadingByID === true || reviewByID === "" ? (
				...
				<Container className="h-footer tw-mt-10">
					<Row className="d-flex justify-content-center">
						<Toast
							className="my-toast"
							onClose={() => setShow({ ...show, valid: false })}
							show={show.valid}
							delay={9000}
							autohide
						>
                  ...
                  Review Produk
					...
					<Row className="mx-2 tw-mt-10 tw-mb-10">
						...
						<Col xs={12} lg={6}>
							...
							<div className="tw-mt-10 tw-pb-1">
							<span className="tw-font-opensans tw-font-semibold tw-text-lg letterSpace">
								Description:
							</span>
							</div>

							<div className="tw-flex tw-flex-col tw-border-t tw-border-grey tw-mt-4 tw-py-2">
								<span className="tw-font-opensans desc">
						...
						{alert.status ? (
							...
							<Col xs={12} className="mt-3 tw-pb-16 mt-5 px-4 pt-2 cardBox">
								<div className="tw-font-opensans tw-pt-2 tw-mb-1 tw-font-bold tw-text-lg letterSpace">
									Beri Rating
								</div>
								...
								<div className="tw-font-opensans tw-pt-2 tw-mb-1 tw-font-bold mt-3 tw-text-lg letterSpace">
								Tulis Review
								</div>
								<Form onSubmit={(e) => handleReview(e)}>
									...
									<Button
										type="submit"
										variant="primary"
										className="mt-3 tw-bg-base tw-border-base tw-shadow-base"
									>
										Submit
									</Button>
								</Form>

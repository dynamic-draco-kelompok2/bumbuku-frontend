		...
		<>
			{dataOrder.length === 0 ? (
				...
				<Container>
							...
							<div>
								...
								<div>
									<p className="textSubCart tw-lg:w-1/2">
										Terimakasih User sudah memesan di bumbu Ku! berikut ini
					...
					{/* <div className="tw-bg-base"><p>tes</p></div> */}

					{/* <Container className="tw-bg-black py-5"> */}
						{dataOrder.map((order, index) => (
							<>
							<Row >
							
								<Col className="tw-bg-white borderCustom mr-5 mb-5 tw-ml-4">
								{/* <Col > */}
									<div key={index}>
										<div className="" key="1">
											<div className="">
												...
												{/* <div className="tw-bg-black py-5"></div> */}
